...
-- 3. Atlasīt tikai nosaukuma un gada kolonnas (SELECT)
-- 4. Atlasīt pilsētas kuras ir jaunākas par 250 gadiem (WHERE)
-- 5. Atlasīt pilsētas ar mazāk vai vienādas ar 5100 iedzīvotāju skaitu (WHERE)
-- 6. Atlasīt top 20 lielākas pilsētas pēc iedzīvotāju skaita (LIMIT, ORDER BY)
...
-- QUERY database
SELECT * FROM cities;
SELECT * FROM cities WHERE citiesID = 1;
